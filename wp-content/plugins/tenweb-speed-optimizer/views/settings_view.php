...
$two_events_after_load_check = is_array( $two_events_after_load ) ? $two_events_after_load : array() ;
        ...
        <form class="two_settings_form" action="" method="post">
            ...
            <div class="two_settings_tab two_tab_css">
                ...
                <div class="two_settings_option">
                    ...
                    <label for="two_add_overflow_to_page" class="wd-label"><?php _e('Force page overflow to be visible', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Add "overflow: visible !important;" to selected tags.', 'tenweb-speed-optimizer') ?></p>
                </div>
            ...
            <div class="two_settings_tab two_tab_js">
                ...
                <div class="two_settings_option two_plugins_to_exclude" <?php if ($two_delay_all_js_execution != "on")
                    echo 'style="display:none"' ?>>
                    <label for="two_delay_js_exclusions" class="wd-label"><?php _e('Exclude plugins/themes/scripts from delay all js.', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('Check plugins that you have issues with. All scripts from the excluded plugins/themes/scripts will be loaded in the traditional way, and won\'t be delayed. That may affect score. ', 'tenweb-speed-optimizer') ?></p>
