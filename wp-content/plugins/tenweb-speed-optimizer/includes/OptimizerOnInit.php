...
class OptimizerOnInit
{
    public function __construct()
    {
        ...
        add_action( 'admin_bar_menu', array( $this, 'two_admin_bar'), 71);
        ...
        add_action('admin_notices', array( $this, 'two_admin_banners' ));
        add_action( 'wp_ajax_two_send_nps_survey_data', array( '\TenWebOptimizer\OptimizerBanner', 'two_send_nps_survey_data' ));
        add_action( 'wp_ajax_two_set_autoupdate_from_banner', array( '\TenWebOptimizer\OptimizerBanner', 'two_set_autoupdate_from_banner' ));
