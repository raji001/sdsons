...
if ( ! class_exists( 'YITH_YWRAQ_Send_Email_Request_Quote' ) ) {
	...
	class YITH_YWRAQ_Send_Email_Request_Quote extends WC_Email {
		...
		public function __construct() {
        	...
        	$this->subject = __( 'SD & Sons Product request quote', 'yith-woocommerce-request-a-quote' );
        	...
        	$this->cc_recipient = $this->get_option( 'cc_recipient' );
        
        	if ( ! $this->cc_recipient ) {
        		$this->cc_recipient = '';
        	}
		...
		public function trigger( $args ) {
			...
			if ( $return || apply_filters( 'ywraq_check_send_email_request_a_quote', false ) || defined( 'YWTENV_INIT' ) ) {
				...
				yith_ywraq_add_notice( __( '<strong>Thank you for choosing our Product!</strong><br/> Our expert will be in touch with you shortly to discuss the details.', 'yith-woocommerce-request-a-quote' ), 'success' );
			} else {
		...
		public function get_headers() {
        	...
        	if ( $this->enable_cc && $this->cc_recipient ) {
        		$headers .= 'Cc: ' . $this->cc_recipient . "\r\n";
        	}
		...
		public function init_form_fields() {
			$this->form_fields = array(
				...
				'cc_recipient'     => array(
        			'title'         => __( 'CC Recipient', 'yith-woocommerce-request-a-quote' ),
        			'type'          => 'email',
        			'description'   => __( 'Email address to receive a CC copy of this email.', 'yith-woocommerce-request-a-quote' ),
        			'default'       => '',
        			'placeholder'   => '',
