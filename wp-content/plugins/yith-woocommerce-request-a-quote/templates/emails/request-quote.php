...
$headers[] = 'Cc: rajkumara@venzotechnologies.com'; // replace with the CC email address
?>
...
<p><strong><?php esc_html_e( 'Phone:', 'yith-woocommerce-request-a-quote' ); ?></strong> <?php echo esc_html( $raq_data['user_phone'] ); ?></p>
